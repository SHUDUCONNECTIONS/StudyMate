...
export const EmergencyPage = () => {
  return (
    <div className="max-w-4xl mx-auto text-center pt-8 md:pt-12 flex flex-col items-center px-4">
      <div className="w-20 h-20 md:w-28 md:h-28 bg-white border-4 border-black rounded-[2rem] md:rounded-[3rem] text-red-600 flex items-center justify-center mb-6 md:mb-8 rotate-3 shadow-[6px_6px_0px_0px_rgba(239,68,68,1)]">
        <PhoneCall size={window.innerWidth < 768 ? 32 : 40} className="animate-pulse" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 w-full text-left">
        <div className="yandasm-pop-card bg-brand-yellow p-6 border-2 border-black shadow-[4px_4px_0px_0px_#000]">
           <h4 className="font-black uppercase tracking-widest text-[10px] mb-2">Ambulance</h4>
           <p className="text-xl md:text-2xl font-display font-black text-black">10177</p>
        </div>
        <div className="yandasm-pop-card bg-brand-teal text-white p-6 border-2 border-black shadow-[4px_4px_0px_0px_#000]">
           <h4 className="font-black uppercase tracking-widest text-[10px] mb-2 text-black/40">SAPS Police</h4>
           <p className="text-xl md:text-2xl font-display font-black">10111</p>
        </div>
        <div className="yandasm-pop-card bg-brand-lavender p-6 border-2 border-black shadow-[4px_4px_0px_0px_#000]">
           <h4 className="font-black uppercase tracking-widest text-[10px] mb-2">SADAG (Mental Health)</h4>
           <p className="text-xl md:text-2xl font-display font-black">0800 456 789</p>
        </div>
        ...
        <div className="yandasm-pop-card bg-brand-blue text-white p-6 border-2 border-black shadow-[4px_4px_0px_0px_#000]">
           <h4 className="font-black uppercase tracking-widest text-[10px] mb-2 text-white/40">Childline</h4>
           <p className="text-xl md:text-2xl font-display font-black text-white">116</p>
        </div>
        <div className="yandasm-pop-card bg-brand-orange text-white p-6 border-2 border-black shadow-[4px_4px_0px_0px_#000]">
           <h4 className="font-black uppercase tracking-widest text-[10px] mb-2 text-white/40">GBV Command Centre</h4>
           <p className="text-xl md:text-2xl font-display font-black">0800 428 428</p>
        </div>
      </div>
    </div>
  );
